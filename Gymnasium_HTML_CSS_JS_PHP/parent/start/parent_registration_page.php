		...
		<div id="content1"> 
			<div id="formForStudentRegistration">
				<center>
					...
					<form action="parent_registration.php" method="post" name="form">
						<table>
							<tr>
								<td align=right> Ваша фамилия: </td>
								<td align=left> <input type="text" name="parent_surname"> </td>
							</tr>
							<tr>
								<td align=right> Ваше имя: </td>
								<td align=left> <input type="text" name="parent_name"> </td>
							</tr>
							<tr>
								<td align=right> Фамилия ребенка: </td>
								<td align=left> <input type="text" name="child_surname"> </td>
							</tr>
							<tr>
								<td align=right> Имя ребенка: </td>
								<td align=left> <input type="text" name="child_name"> </td>
							</tr>
							<tr>
